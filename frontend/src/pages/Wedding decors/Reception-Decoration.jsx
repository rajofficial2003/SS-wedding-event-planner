...
const ReceptionDecoration = () => {
  ...
  const loadReceptionData = async () => {
    try {
      ...
      // Get all categories
      const categoriesData = await receptionService.getAllCategories()
      ...
      for (const categoryName of categoryNames) {
        const images = await receptionService.getCategoryImages(categoryName)
    ...
    <div className="reception-decoration-page">
      ...
      <Container className="py-4">
        <p className="mb-4" style={{ lineHeight: "1.8" }}>
          There's no denying that the decor for your reception decorations are important. After all, half your
          photographs are clicked on the stage! So whether you want a simple design, or you're looking for something
          royal and grand, here, at Vermilion Events and Decors we offer the best reception decorations for your
          weddings.
        </p>
        ...
        {loading ? (
          <div className="text-center py-5">
            ...
            <p className="mt-2">Loading reception decorations...</p>
          </div>
        ) : (
          <>
        ...
        {loading ? null : filteredImages.length > 0 ? (
              ...
              <Col key={`${image.fileName || image.name}_${index}`} xs={12} sm={6} md={4} className="gallery-item mb-4">
                ...
                >
                  <img
                    ...
                    alt={image.name || `Reception decoration ${index + 1}`}
          ...
          <div className="text-center py-5">
            <p style={{ fontFamily: "Poppins, sans-serif", color: "#777" }}>
              {categories.length === 0
                ? "No reception decorations available yet. Please check back soon!"
