...
export class SangeetmehandiService {
  constructor() {
    this.collectionName = "sangeetmehandi"
  }
  ...
  async uploadImage(file, categoryName) {
    try {
      ...
      const storageRef = ref(storage, `sangeetmehandi/${categoryName}/${fileName}`)
...
export const sangeetmehandiService = new SangeetmehandiService()
