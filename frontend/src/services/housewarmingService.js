...
export class HousewarmingService {
  constructor() {
    this.collectionName = "housewarming"
  }
  ...
  async uploadImage(file, categoryName) {
    try {
      ...
      const storageRef = ref(storage, `housewarming/${categoryName}/${fileName}`)
...
export const housewarmingService = new HousewarmingService()
